...
namespace Bquiz.Display.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous] //ai vô cũng được
        //[Authorize] //phải đăng nhập mới được
        //[Authorize(Roles="admin")] //phải là admin mới vô được
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    WebSecurity.CreateUserAndAccount(
                        ...
                        {
                            UserId = userId,
                            Email = string.Format("{0}@bquiz.vn", model.UserName)
                        });
